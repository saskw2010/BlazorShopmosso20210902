namespace BlazorShop.Web.Server.Controllers
{
    ...
    public class ShoppingCartsController : ApiController
    {
        ...
        [HttpPost(nameof(ConfirmUserCart))]
        public async Task<ActionResult> ConfirmUserCart(
            List<ShoppingCartRequestModel> cartItems)
            => await this.shoppingCarts
                .ConfirmUserCart(cartItems, this.currentUser.UserId)
                .ToActionResult();
    }
}
