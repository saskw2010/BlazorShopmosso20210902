...
{
    using System.Collections.Generic;/*saeed*/
    ...
    {
        private const string ShoppingCartsPath = "api/shoppingcarts";/*saeed*/
        ...
        //saeed
        public async Task<IEnumerable<Models.ShoppingCarts.ShoppingCartProductsResponseModel>> Mine()
            => await this.http.GetFromJsonAsync<IEnumerable<Models.ShoppingCarts.ShoppingCartProductsResponseModel>>(ShoppingCartsPath);
      }
}