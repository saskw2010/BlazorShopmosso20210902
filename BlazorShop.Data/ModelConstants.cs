namespace BlazorShop.Data
{
    public class ModelConstants
    {
        ...
        public class Product
        {
            ...
            //public const int MaxImagebinaryLength = 1000000;
            public const int MaxDescriptionLength = 1000;
            public const int MaxProductCodeLength = 100;
        ...
        public class Category
        {
            ...
            public const int MaxQuantity = int.MaxValue;
            public const int MaxUrlLength = 2048;
            public const int MaxImageBinary = 7000;
            public const int MaxImagepic = 7000;
            //public const int MaxImagebinaryLength = 1000000;
            //public const int MaxDescriptionLength = 1000;
            //public const int MaxProductCodeLength = 100;
            //public const string MinPrice = "1";
