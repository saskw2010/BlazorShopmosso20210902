namespace BlazorShop.Data
{
    ...
    public class BlazorShopDbContext : IdentityDbContext<BlazorShopUser, BlazorShopRole, string>
    {
        ...
        //mostafa
       // public DbSet<OrderProductRecipients> OrderProductRecipients { get; set; }
       //  public DbSet<OrdersProductmosso> OrdersProductmosso { get; set; }
        public DbSet<OrdersProductRecipientsmosso> OrdersProductRecipientsmosso { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //builder.Entity<OrderProductRecipients>(entity =>
            //{
            //     entity.HasOne(d => d.OrderProduct)
            //        .WithMany(p => p.OrdersProductRecipientsmosso)
            //        .HasForeignKey(d => d.OrdersProductId)
            //        .HasConstraintName("FK_OrderProductRecipients_OrdersProducts");
            //});
